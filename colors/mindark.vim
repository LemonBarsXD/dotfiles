...
" Comments
hi Comment          cterm=none      ctermbg=none    ctermfg=brown
...
" Stuff
syntax keyword CustomType int char float double bool unsigned typedef struct class enum if else while for switch continue pass return break
hi CustomType ctermfg=yellow guifg=yellow
